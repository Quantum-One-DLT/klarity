...
Feature: Receive money
  ...
  Scenario: Hide/show "Sophie" wallet used addresses
  ...
  Scenario: Hide/show "Cole" wallet used addresses
    Given I am on the "Target Wallet" wallet "receive" screen
  ...
  Scenario: Cole Wallet addresses ordering
    Given I am on the "Target Wallet" wallet "receive" screen
    And I enter wallet password in generate address input field "Secret1234"
  ...
  Scenario: Generate "Cole" wallet address with wrong passphrase
    Given I am on the "Target Wallet" wallet "receive" screen
  ...
  Scenario: Generate "Cole" wallet address with too short passphrase
    Given I am on the "Target Wallet" wallet "receive" screen
