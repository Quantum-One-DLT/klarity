...
Feature: App Update
  ...
  Scenario: 2.2.0 not installed, download is interrupted, file is deleted
    ...
    And reopen the app
    Then I should see the update overlay
    And the overlay should display a red text saying "We were unable to launch the update installer automatically. Please manually update Klarity to its latest version."
