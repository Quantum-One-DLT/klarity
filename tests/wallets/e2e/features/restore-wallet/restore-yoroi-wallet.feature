...
Feature: Restore Yoroi wallet
  ...
  Scenario: Successfully restoring "Yoroi Cole" cole wallet
    ...
    And I enter wallet name "Yoroi Cole wallet" in restore wallet dialog
    ...
    And I should have newly created "Yoroi Cole wallet" wallet loaded
    And "Yoroi Cole wallet" wallet should have "legacy_aab5517861cca76a53d83e24c84542ecac6c0a3d" as id
  ...
  Scenario: Successfully restoring "Yoroi Sophie" sophie wallet
    Given The sidebar shows the "wallets" category
    When I click on the add wallet button in the sidebar
    And I see the add wallet page
    And I click on the restore wallet button on the add wallet page
    ...
    And I enter recovery phrase in restore wallet dialog:
      ...
      | defense brush fiscal cactus rotate trouble mean quantum shrug slight dignity corn immense first citizen |
    And I click Check recovery phrase button
    And I enter wallet name "Yoroi Sophie wallet" in restore wallet dialog
    And I enter wallet password in restore wallet dialog:
      | password  | repeatedPassword |
      | Secret1234 | Secret1234      |
    And I click continue
    ...
    And I click close
    Then I should not see the restore wallet dialog anymore
    And I should have newly created "Yoroi Sophie wallet" wallet loaded
    And "Yoroi Sophie wallet" wallet should have "aab5517861cca76a53d83e24c84542ecac6c0a3d" as id

  Scenario: Successfully restoring "Yoroi Cole" wallet
    Given The sidebar shows the "wallets" category
    When I click on the add wallet button in the sidebar
    And I see the add wallet page
    And I click on the restore wallet button on the add wallet page
    ...
    Then I should not see the restore wallet dialog anymore
    And I should have newly created "Yoroi Cole wallet" wallet loaded
    And "Yoroi Cole wallet" wallet should have "legacy_ca8f1986634654c7937c6f931872a1712998b17b" as id
