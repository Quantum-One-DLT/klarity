...
export const initialSettingsHelpers = {
  ...
  ensureLanguageIsSelected: async (
    ...
    client.execute(
      () => klarity.actions.profile.finishInitialScreenSettings.trigger()
    );
...
export const migrationHelpers = {
  ...
  acceptMigration: async (client: Object) => {
    await client.execute(() => {
      klarity.actions.profile.acceptDataLayerMigration.trigger();
    });
...
export const termsOfUseHelpers = {
  ...
  acceptTerms: async (client: Object) => {
    await client.execute(() => {
      klarity.actions.profile.acceptTermsOfUse.trigger();
    });
