...
const exportedCSVContent = [['Wallet', 'Reward', 'Date'], ['Test Wallet', '1,000,000.000000 BCC', moment().format('YYYY-MM-DDTHHmmss.0SSS')]];
...
Then(/^I click on the Export to CSV button$/, async function () {
  ...
  await this.client.execute(({
    ...
    klarity.actions.wallets.generateCsv.trigger({
      fileContent,
      filePath,
    });
  }, data);
