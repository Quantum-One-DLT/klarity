...
export const osxMenu = (
  ...
  {
    label: translation('klarity'),
    submenu: compact([
      {
        label: translation('klarity.about'),
        click() {
      ...
      { type: 'separator' },
      {
        label: translation('klarity.redeemItnRewards'),
      ...
      { type: 'separator' },
      {
        label: translation('klarity.settings'),
        accelerator: 'Command+,',
        click() {
      ...
      {
        label: translation('klarity.walletSettings'),
        accelerator: 'Command+;',
        click() {
      ...
      { type: 'separator' },
      {
        label: translation('klarity.hideKlarity'),
        role: 'hide',
      },
      {
        label: translation('klarity.hideOthers'),
        role: 'hideothers',
      },
      {
        label: translation('klarity.showAll'),
        role: 'unhide',
      },
      { type: 'separator' },
      {
        label: translation('klarity.quit'),
  ...
  },
  {
    ...
    submenu: compact([
      ...
      { type: 'separator' },
      {
        label: translation('helpSupport.klarityDiagnostics'),
        accelerator: 'Command+D',
        click() {
          actions.openKlarityDiagnosticsDialog();
        },
        enabled: isNavigationEnabled,
      },
    ]),
