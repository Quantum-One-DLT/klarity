...
export const evaluateNetwork = (network: ?string) => {
  ...
  if (network === 'aurum-purple') {
    currentNetwork = AURUM_PURPLE;
  }
...
export const getBuildLabel = (
  ...
  let buildLabel = `Klarity ${networkLabel} (${version}#${build})`;
...
export const checkIsAurumPurple = (network: string) =>
  network === AURUM_PURPLE;
