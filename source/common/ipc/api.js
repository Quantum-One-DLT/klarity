...
import type { ExportedColeWallet } from '../../renderer/app/types/walletExportTypes';
import type {
...
import type {
  ...
  HardwareWalletBccBccAppResponse,
 ...
 * to communicate with the bcc-node manager code.
 * ==================================================================
 */

/**
 * Channel to indicate that bcc-node will exit for updating
 */
export const BCC_AWAIT_UPDATE_CHANNEL = 'BCC_AWAIT_UPDATE_CHANNEL';
export type BccAwaitUpdateRendererRequest = void;
export type BccAwaitUpdateMainResponse = void;

/**
 * Channel where main process tells the renderer about bcc-node state updates
 */
export const BCC_STATE_CHANNEL = 'BCC_STATE_CHANNEL';
export type BccStateRendererRequest = void;
export type BccStateRendererResponse = BccNodeState;

/**
 * Channel to exchange tls config between main and renderer process
 */
export const BCC_TLS_CONFIG_CHANNEL = 'BCC_TLS_CONFIG_CHANNEL';
export type BccTlsConfigRendererRequest = void;
export type BccTlsConfigMainResponse = ?TlsConfig;

/**
 * Channel where renderer can request a bcc-node restart
 */
export const BCC_RESTART_CHANNEL = 'BCC_RESTART_CHANNEL';
export type BccRestartRendererRequest = void;
export type BccRestartMainResponse = void;

/**
 * Channel where render process can toggle bcc-node fault injections
 */
export const BCC_FAULT_INJECTION_CHANNEL =
  'BCC_FAULT_INJECTION_CHANNEL';
export type BccFaultInjectionRendererRequest = FaultInjectionIpcRequest;
export type BccFaultInjectionMainResponse = void;

/**
 * Channel where renderer can ask for the last cached bcc-node status
 */
export const GET_CACHED_BCC_STATUS_CHANNEL =
  'GET_CACHED_BCC_STATUS_CHANNEL';
export type GetCachedBccStatusRendererRequest = void;
export type GetCachedBccStatusMainResponse = ?BccStatus;

/**
 * Channel where renderer and main process can exchange bcc-node status info
 */
export const SET_CACHED_BCC_STATUS_CHANNEL =
  'SET_CACHED_BCC_STATUS_CHANNEL';
export type SetCachedBccStatusRendererRequest = ?BccStatus;
export type SetCachedBccStatusMainResponse = void;
...
export type ExportWalletsMainResponse = {
  wallets: Array<ExportedColeWallet>,
  errors: string,
};
...
/**
 * Channel for quitting Klarity and installing update
 */
...
export const GET_BCC_BCC_APP_CHANNEL = 'GET_BCC_BCC_APP_CHANNEL';
export type getBccBccAppRendererRequest = { path: ?string };
export type getBccBccAppMainResponse = HardwareWalletBccBccAppResponse;
