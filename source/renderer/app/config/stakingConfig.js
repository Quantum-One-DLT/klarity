...
export const MIN_REWARDS_REDEMPTION_RECEIVER_BALANCE = 1; // 1 BCC | unit: BCC
export const REWARDS_REDEMPTION_FEE_CALCULATION_AMOUNT = 1 * 1000000; // 1 BCC | unit: entropic
...
export const DELEGATION_DEPOSIT = 2; // 2 BCC | unit: entropic
