...
const messages = defineMessages({
  errorMinRewardFunds: {
    ...
    defaultMessage:
      '!!!This wallet does not contain the minimum amount of {calculatedMinRewardsReceiverBalance} BCC which is required to cover the necessary transaction fees. Please select a wallet with <span>a minimum amount of {calculatedMinRewardsReceiverBalance} BCC</span> and click continue.',
    description:
