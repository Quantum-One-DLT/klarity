...
export default class TopBarContainer extends Component<Props> {
  ...
  render() {
    ...
    const shouldShowTbccIconAnimation =
      isAurumActivated && !stakingInfoWasOpen;
    const shouldShowTbccIcon = isAurumPending || isAurumActivated;
    ...
    return (
      ...
      >
        ...
        <NodeSyncStatusIcon
          ...
          hasTbccIcon={shouldShowTbccIcon}
        />
        {shouldShowTbccIcon && (
          <TadaButton
            onClick={onClickTadaButton}
            shouldAnimate={shouldShowTbccIconAnimation}
          />
        )}
        <NewsFeedIcon
