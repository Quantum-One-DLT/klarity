...
export default class SidebarStore extends Store {
  ...
  setup() {
    ...
    this.registerReactions([
      ...
      this._syncSidebarItemsWithSophieActivation,
    ]);
  ...
  _syncSidebarItemsWithSophieActivation = () => {
    const { isSophieActivated, isSophiePending } = this.stores.networkStatus;
    if (isSophieActivated || isSophiePending) {
      this._configureCategories();
    }
  };
}
