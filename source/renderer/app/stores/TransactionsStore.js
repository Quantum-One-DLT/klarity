...
export default class TransactionsStore extends Store {
  ...
  deleteTransactionRequest: Request<DeleteTransactionRequest> = new Request(
    this.api.bcc.deleteTransaction
  );
  @observable
  ...
  calculateTransactionFeeRequest: Request<GetTransactionFeeRequest> = new Request(
    this.api.bcc.calculateTransactionFee
  );
  ...
  @computed get recentTransactionsRequest(): Request<GetTransactionsResponse> {
    ...
    if (!wallet) return new Request(this.api.bcc.getTransactions);
  ...
  validateAmount = (amountInEntropics: string): Promise<boolean> =>
    Promise.resolve(isValidAmountInEntropics(amountInEntropics));
  ...
  _getTransactionsRecentRequest = (
    ...
    return new Request(this.api.bcc.getTransactions);
  };
  ...
  _getWithdrawalsRequest = (
    ...
    return new Request(this.api.bcc.getWithdrawals);
  };
