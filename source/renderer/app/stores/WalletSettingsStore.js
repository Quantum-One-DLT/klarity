...
========================================================== */
  ...
  @action _recoveryPhraseVerificationCheck = async ({
    ...
    runInAction(
      'BccWalletBackupStore::_recoveryPhraseVerificationCheck',
      () => {
