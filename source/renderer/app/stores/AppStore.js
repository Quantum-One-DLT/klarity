...
export default class AppStore extends Store {
  ...
  setup() {
    ...
    this.actions.app.closeKlarityDiagnosticsDialog.listen(() => {
      this._closeActiveDialog();
    });
    this.actions.app.openKlarityDiagnosticsDialog.listen(() => {
      this._updateActiveDialog(DIALOGS.KLARITY_DIAGNOSTICS);
    });
  ...
  showUiPart = (uiPart: string) => {
    ...
    switch (uiPart) {
      case DIALOGS.ABOUT:
        this._updateActiveDialog(DIALOGS.ABOUT);
        break;
      case DIALOGS.KLARITY_DIAGNOSTICS:
        this._updateActiveDialog(DIALOGS.KLARITY_DIAGNOSTICS);
        break;
