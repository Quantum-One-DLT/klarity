...
export const messages = defineMessages({
  ...
  cannotCoverFee: {
    ...
    defaultMessage: '!!!Not enough bcc for fees. Try sending a smaller amount.',
    description:
      '"Not enough bcc for fees. Try sending a smaller amount." error message',
  },
  inputsDepleted: {
    id: 'api.errors.inputsDepleted',
    defaultMessage:
      '!!!Your wallet contains only reward funds. Please send at least one BCC to your wallet so that you can spend the funds.',
    description:
      '"Your wallet contains only reward funds. Please send at least one BCC to your wallet so that you can spend the funds." error message',
  },
  transactionIsTooBig: {
  ...
  notEnoughFundsForTransaction: {
    ...
    defaultMessage: '!!!Not enough bcc. Try sending a smaller amount.',
    description:
      '"Not enough bcc . Try sending a smaller amount." error message',
  },
  invalidAddress: {
  ...
  tooBigTransactionErrorLinkURL: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/360017733353',
    description:
  ...
  nothingToMigrate: {
    ...
    defaultMessage:
      '!!!Funds cannot be transferred from this wallet because it contains some unspent transaction outputs (UTXOs), with amounts of bcc that are too small to be migrated.',
    description:
      '"Funds cannot be transferred from this wallet because it contains some unspent transaction outputs (UTXOs), with amounts of bcc that are too small to be migrated." error message',
  },
  invalidSmashServer: {
