...
export type LegacyBccWallets = Array<LegacyBccWallet>;

export type WalletUnit = WalletUnits.ENTROPIC | WalletUnits.BCC;

export type BccWallets = Array<BccWallet>;
...
export type WalletBalance = {
  quantity: number,
  unit: WalletUnits.ENTROPIC | WalletUnits.BCC,
};
...
export type RestoreExportedColeWalletRequest = ExportedColeWallet;
