...
import { formattedEntropicToAmount } from './formatters';
...
export const getUtxoChartData = (histogram: Histogram): UtxoChartData =>
  Object.entries(histogram)
    .sort()
    .reduce((data, [entropicWalletAmount, walletUtxosAmount]) => {
      const walletAmount = formattedEntropicToAmount(
        parseInt(entropicWalletAmount, 10)
      );
