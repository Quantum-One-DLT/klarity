...
const messages = defineMessages({
  ...
  content1: {
    ...
    defaultMessage:
      '!!!You have installed a version of Klarity that changes how wallet data is stored and managed. Because of this, all of your wallets need to be restored and synchronized with the complete history of the Bcc blockchain.',
