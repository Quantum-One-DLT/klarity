...
const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      '!!!Choose a wallet that holds the funds you want to delegate. The selected wallet must contain a <span>minimum amount of {minDelegationFunds} BCC</span> for delegation to be an option.',
    description:
  ...
  errorMinDelegationFunds: {
    ...
    defaultMessage:
      '!!!This wallet does not contain the minimum amount of {minDelegationFunds} BCC which is required for delegation to be available. Please select a wallet with <span>a minimum amount of {minDelegationFunds} BCC</span> and click continue.',
    description:
