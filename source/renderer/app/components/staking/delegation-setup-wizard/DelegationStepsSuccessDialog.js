...
const messages = defineMessages({
  ...
  descriptionLine2: {
    ...
    defaultMessage:
      '!!!Your new delegation preferences are now posted on the Bcc blockchain. <strong>These preferences will take effect after both the current and the next Bcc epochs have completed in {timeUntilNextEpochStart}.</strong> During this time, your previous delegation preferences remain active.',
    description:
