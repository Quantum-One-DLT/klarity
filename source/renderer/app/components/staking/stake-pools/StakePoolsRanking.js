...
const messages = defineMessages({
  ...
  rankingLearnMoreUrl: {
    ...
    defaultMessage: '!!!https://tbco.zendesk.com/hc/en-us',
  ...
  rankingMinTooltip: {
    ...
    defaultMessage: '!!!Minimum BCC required for staking',
    description: 'Minimum BCC required for staking slider tooltip.',
  },
  actionLearnMore: {
