...
import { DECIMAL_PLACES_IN_BCC } from '../../../config/numbersConfig';
import {
  bigNumberComparator,
  stringComparator,
...
const messages = defineMessages({
  ...
  tableHeaderReward: {
    ...
    defaultMessage: '!!!Total rewards earned (BCC)',
  ...
  note: {
    ...
    defaultMessage:
      '!!!<p>Rewards earned by delegating your stake are automatically collected into your reward account.</p><p>Rewards earned on the Incentivized Testnet are not added to your Rewards wallet balance. They will be paid to you in real bcc on the Bcc mainnet after the end of the Incentivized Testnet.</p><p>If you are using funds from this wallet to operate a stake pool, the rewards displayed here may include your pledged stake, which will not be counted when reward balances are paid out on the Bcc mainnet.</p>',
              ...
              <table>
                ...
                <tbody>
                  {map(sortedRewards, (reward, key) => {
                    ...
                    ).toFormat(DECIMAL_PLACES_IN_BCC);
