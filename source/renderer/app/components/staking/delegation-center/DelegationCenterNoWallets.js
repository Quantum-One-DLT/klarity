...
const messages = defineMessages({
  headLine: {
    ...
    defaultMessage:
      '!!!The delegation center is not available because you currently do not have any Sophie-compatible wallets.',
    description: '"No wallets" headLine on the Delegation centre Page.',
  },
  instructions: {
    id: 'staking.delegationCenter.noWallets.instructions',
    defaultMessage:
      '!!!Create a new wallet and transfer in a minimum of {minDelegationFunds} BCC (or restore an existing wallet with funds), then return here to delegate your stake.',
