...
const messages = defineMessages({
  heading: {
    ...
    defaultMessage: '!!!Bcc is transitioning into a decentralized system',
    description: 'Headline for the Decentralization progress notification.',
  },
  description: {
    id: 'staking.info.description',
    defaultMessage:
      '!!!Bcc is transitioning from a federated system operated by its creators to a decentralized system operated by a community of stake pool operators. During this transition, blocks will be produced both by the federated nodes and by stake pools. The percentage of blocks produced by stake pools will increase every epoch until block production in the Bcc network becomes fully decentralized.',
    description:
