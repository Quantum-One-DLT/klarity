...
const messages = defineMessages({
  ...
  description1: {
    ...
    defaultMessage:
      '!!!If you participated in the { itnLink } and earned rewards by running a stake pool or delegating your stake, you can use this feature to redeem your rewards as bcc on the Bcc mainnet.',
    description: 'description for Redeem Incentivized Testnet - Step 1',
  },
  description2: {
    id: 'staking.redeemItnRewards.step1.description2',
    defaultMessage:
      '!!!You will need the <b>wallet recovery phrase for the Incentivized Testnet wallet</b> used to earn rewards and an existing mainnet wallet in Klarity to which the rewards will be transferred. This wallet will also be used to pay any applicable transaction fees.',
    description: 'description for Redeem Incentivized Testnet - Step 1',
  },
  ...
  descriptionItnLinkUrl: {
    ...
    defaultMessage: '!!!https://staking.bcc.org/',
    description:
  ...
  learnMoreLinkUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/900001656586',
