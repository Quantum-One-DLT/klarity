...
const messages = defineMessages({
  ...
  overlayTextP1: {
    ...
    defaultMessage:
      '!!!Attention, Klarity is unable to sync with the blockchain because the time on your machine is different from the global time. Your time is off by 2 hours 12 minutes 54 seconds.',
  ...
  ntpUnreachableTextP1: {
    ...
    defaultMessage:
      '!!!Attention, Klarity is unable to check if the clock on your computer is synchronized with global time because NTP (Network Time Protocol) servers are unreachable, possibly due to firewalls on your network.',
  ...
  ntpUnreachableTextP2: {
    ...
    defaultMessage:
      '!!!If your computer clock is off by more than 15 seconds, Klarity will be unable to connect to the network. If you have this issue, please read our Support Portal article to synchronize the time on your machine.',
    description: 'Text of Sync error overlay when NTP service is unreachable',
  },
  supportPortalLink: {
  ...
  supportPortalLinkUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/360010230873',
    description:
      'Link to "Machine clock out of sync with Bcc network" support page',
  },
