...
const messages = defineMessages({
  ...
  connecting_known: {
    ...
    description: '"Connect the TBCO Trezor 1 device" device state',
  },
  launching_bcc_app: {
    id: 'wallet.hardware.deviceStatus.launching_bcc_app',
    defaultMessage: '!!!Launch Bcc application on your device',
    description: '"Launch Bcc application on your device" device state',
  },
  ...
  verifying_transaction: {
    ...
    description:
      '"Confirm the transaction using the TBCO Trezor 1 device" device state',
  },
  ...
  trezor_bridge_failure_link_url: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/360011451693',
  ...
  wrong_bcc_app_version: {
    id: 'wallet.hardware.deviceStatus.wrong_bcc_app_version',
    defaultMessage: '!!!Outdated Ledger software!! {instructionsLink}',
    description: '"Unsupported firmware!" device state',
  },
  wrong_bcc_app_version_link_label: {
    id: 'wallet.hardware.deviceStatus.wrong_bcc_app_version.link.label',
    defaultMessage: '!!!Software update instructions',
    description: 'Firmware update installation instructions link label',
  },
  wrong_bcc_app_version_link_url: {
    id: 'wallet.hardware.deviceStatus.wrong_bcc_app_version.link.url',
    defaultMessage:
      '!!!https://support.ledger.com/hc/en-us/articles/360020095874-Bcc-BCC-',
    description: 'URL for the "Firmware Update"',
  },
  verifying_address: {
...
export default class HardwareWalletStatus extends Component<Props, State> {
  ...
  UNSAFE_componentWillReceiveProps(nextProps: Props) {
    if (nextProps.hwDeviceStatus !== this.props.hwDeviceStatus) {
      ...
      if (
        ...
        this.props.hwDeviceStatus === HwDeviceStatuses.LAUNCHING_BCC_APP
      ) {
        setTimeout(() => {
  ...
  render() {
    ...
    const isLoading =
      ...
      hwDeviceStatus === HwDeviceStatuses.LAUNCHING_BCC_APP ||
    ...
    const hasErrored =
      ...
      hwDeviceStatus === HwDeviceStatuses.WRONG_BCC_APP_VERSION ||
