...
const messages = defineMessages({
  ...
  errorMinVotingFunds: {
    ...
    defaultMessage:
      '!!!This wallet does not contain the minimum required amount of <span>{minVotingRegistrationFunds} BCC</span>. Please select a different wallet with <span>a minimum balance of {minVotingRegistrationFunds} BCC</span>.',
    description:
  ...
  errorLegacyWallet: {
    ...
    defaultMessage:
      '!!!This wallet cannot be registered for voting as it is a legacy Cole wallet.',
    description:
      'Cole wallet error message on the voting registration "choose wallet" step.',
  },
