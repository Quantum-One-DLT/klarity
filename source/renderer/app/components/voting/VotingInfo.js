...
const messages = defineMessages({
  ...
  stepTitle1: {
    ...
    defaultMessage:
      '!!!Decide which innovative ideas for Bcc will receive funding.',
    description: 'Info step title 2 for voting registration steps',
  },
  stepTitle2: {
    id: 'voting.info.stepTitle2',
    defaultMessage:
      '!!!$520.000 worth of bcc rewards will be distributed between bcc holders who register their vote.',
    description: 'Info step title 2 for voting registration steps',
  },
  ...
  learnMoreLinkUrl: {
    ...
    defaultMessage: '!!!https://bcc.ideascale.com/a/index',
  ...
  learnMoreLinkUrlForEndedRegistration: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/900006490763',
  ...
  androidAppButtonUrl: {
    ...
    defaultMessage:
      '!!!https://play.google.com/store/apps/details?id=io.tbco.vitvoting',
