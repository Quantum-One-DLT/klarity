...
const messages = defineMessages({
  headLine: {
    ...
    defaultMessage:
      '!!!Voting registration for Fund6 is not available as you currently do not have any Sophie-compatible wallets.',
    description: '"No wallets" headLine on the voting info page.',
  },
  instructions: {
    id: 'voting.info.noWallets.instructions',
    defaultMessage:
      '!!!Create a new wallet and transfer a minimum of {minVotingFunds} BCC (or restore an existing wallet with funds), then return here to register for voting.',
