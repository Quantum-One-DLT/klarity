...
const messages = defineMessages({
  ...
  descriptionLinkUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.io/en/blog/posts/2020/11/17/in-pools-we-trust/',
    description: 'description for the Stake Pools settings page.',
  },
  descriptionTBCOContent1: {
    id: 'settings.stakePools.smash.descriptionTBCOContent1',
    defaultMessage:
      '!!!The TBCO server ensures that registered stake pools are valid, helps to avoid duplicated ticker names or trademarks, and checks that the pools do not feature potentially offensive or harmful information.',
    description: 'description for the Stake Pools settings page.',
  },
  descriptionTBCOContent2: {
    id: 'settings.stakePools.smash.descriptionTBCOContent2',
    defaultMessage:
      '!!!This allows us to deal with any scams, trolls, or abusive behavior by filtering out potentially problematic actors. {link} about the TBCO SMASH server.',
    description: 'description for the Stake Pools settings page.',
  },
  descriptionTBCOLinkLabel: {
    id: 'settings.stakePools.smash.descriptionTBCOLinkLabel',
    defaultMessage: '!!!Read more',
    description: 'description for the Stake Pools settings page.',
  },
  descriptionTBCOLinkUrl: {
    id: 'settings.stakePools.smash.descriptionTBCOLinkUrl',
    defaultMessage:
      '!!!https://tbco.io/en/blog/posts/2020/11/17/in-pools-we-trust/',
    description: 'description for the Stake Pools settings page.',
  },
  descriptionNone: {
    ...
    defaultMessage:
      '!!!<b>This option is not recommended!</b> Without the off-chain metadata server your Klarity client will fetch this data by contacting every stake pool individually, which is a very slow and resource-consuming process. The list of stake pools received is not curated, so Klarity will receive legitimate pools, duplicates, and fake pools. An added risk to this process is that your antivirus or antimalware software could recognize the thousands of network requests as malicious behavior by the Klarity client.',
    description: 'description for the Stake Pools settings page.',
  },
  smashSelectLabel: {
  ...
  smashSelectTBCOServer: {
    id: 'settings.stakePools.smash.select.TBCOServer',
    defaultMessage: '!!!TBCO (Recommended)',
    description:
  ...
  smashSelectDirect: {
    ...
    defaultMessage: '!!!None - let my Klarity client fetch the data',
    description:
      'smashSelectCustomServer option for the "Smash" selection on the Stake Pools settings page.',
  },
...
export default class StakePoolsSettings extends Component<Props, State> {
  ...
  smashSelectMessages = {
    tbco: <FormattedHTMLMessage {...messages.smashSelectTBCOServer} />,
  ...
  renderSmashTypeDropdown = () => {
    ...
    const smashServerTypes = isSelfnode
      ? omit(
          SMASH_SERVER_TYPES,
          SMASH_SERVERS_LIST[SMASH_SERVER_TYPES.TBCO].name
        )
      : SMASH_SERVER_TYPES;
  ...
  renderBottomContent = () => {
    ...
    if (smashServerType === SMASH_SERVER_TYPES.TBCO) {
      return (
        <div className={styles.optionDescription}>
          <p>{intl.formatMessage(messages.descriptionTBCOContent1)}</p>
          <p>
            <FormattedMessage
              {...messages.descriptionTBCOContent2}
              values={{
                link: (
                  <Link
                    onClick={() =>
                      onOpenExternalLink(
                        intl.formatMessage(messages.descriptionTBCOLinkUrl)
                      )
                    }
                    label={intl.formatMessage(
                      messages.descriptionTBCOLinkLabel
                    )}
                  />
                ),
              }}
