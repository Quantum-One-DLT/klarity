...
const messages = defineMessages({
  currencyTitleLabel: {
    ...
    defaultMessage: '!!!Display bcc balances in other currency',
    description:
  ...
  currencyDescription: {
    ...
    defaultMessage:
      '!!!Select a conversion currency for displaying your bcc balances.',
    description:
  ...
  currencyDisclaimer: {
    ...
    defaultMessage:
      '!!!Conversion rates are provided by CoinGecko without any warranty. Please use the calculated conversion value only as a reference. Converted balances reflect the current global average price of bcc on active cryptocurrency exchanges, as tracked by CoinGecko. Bcc conversion is available only to fiat and cryptocurrencies that are supported by CoinGecko, other local currency conversions may not be available.',
    description:
