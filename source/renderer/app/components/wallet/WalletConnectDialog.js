...
const messages = defineMessages({
  ...
  instructions: {
    ...
    defaultMessage:
      '!!!<p>Klarity currently supports Ledger Nano S, Ledger Nano X, and Trezor Model T hardware wallet devices.</p><p>If you are <b>pairing your device with Klarity for the first time</b>, please follow the instructions below.</p><p>If you have <b>already paired your device with Klarity</b>, you don’t need to repeat this step. Just connect your device when you need to confirm a transaction.</p>',
    description: 'Follow instructions label',
  },
  instructionsTrezorOnly: {
    id: 'wallet.connect.dialog.instructionsTrezorOnly',
    defaultMessage:
      '!!!<p><b>Klarity currently supports only Trezor Model T hardware wallet devices.</b></p><p>If you are <b>pairing your device with Klarity for the first time</b>, please follow the instructions below.</p><p>If you have <b>already paired your device with Klarity</b>, you don’t need to repeat this step. Just connect your device when you need to confirm a transaction.</p>',
    description: 'Follow instructions label',
  },
