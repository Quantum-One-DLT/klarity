...
import { HW_SOPHIE_CONFIG } from '../../../config/hardwareWalletsConfig';
...
const messages = defineMessages({
  ...
  supportRequestButtonLabel: {
    ...
    defaultMessage: '!!!Submit a request to TBCO Support',
    description: 'Support request button label',
  },
  supportRequestLinkUrl: {
    id: 'wallet.receive.dialog.supportRequestLinkUrl',
    defaultMessage: '!!!https://tbco.zendesk.com/hc/en-us/requests/new/',
  ...
  invalidAddressConfirmationLabel: {
    ...
    defaultMessage:
      '!!!Yes, I am sure I have compared the address displayed in Klarity with the address displayed on the {deviceType} device by comparing the beginning and ending of the address.',
  ...
  verificationCheckOptionInvalid: {
    ...
    defaultMessage:
      '!!!No, I am sure that address displayed in Klarity is different from the address displayed on my {deviceType} device',
  ...
  softwareCheckLabel: {
    ...
    defaultMessage: '!!!Klarity verified the address',
    description: 'Klarity verification status check label',
  },
  ...
  invalidAddressWarningTitle: {
    ...
    defaultMessage: '!!!Warning, your copy of Klarity may be hacked!',
  ...
  invalidAddressWarningDescription: {
    ...
    defaultMessage:
      '!!!You have manually compared the address shown in Klarity with the address shown on the hardware wallet device and reported that they are different. If this is the case, please contact support and make sure you download and attach logs.',
...
export default class WalletReceiveDialog extends Component<Props, State> {
  ...
  constructPaths = (address: WalletAddress) => {
    ...
    const derivationStakingPath = hardenedPathToDerivationPath(
      HW_SOPHIE_CONFIG.DEFAULT_DERIVATION_PATH
    );
