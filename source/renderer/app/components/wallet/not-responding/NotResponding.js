...
const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      '!!!The {walletName} wallet is not responding. This is caused by a known but rare issue, which is currently being fixed. Please restart the Bcc node by clicking the button below, which should resolve the issue. If the issue persists, or if it happens again, please submit a support request.',
