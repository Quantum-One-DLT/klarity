...
const messages = defineMessages({
  ...
  confirmUnsupportNotice: {
    ...
    defaultMessage:
      '!!!I understand that I am not supporting the Bcc network when my stake is undelegated.',
    description:
      'Notice to confirm if the user understands unsupporting Bcc network after undelegation',
  },
