...
export const messages = defineMessages({
  ...
  recoveryPhraseStep3Paragraph1: {
    ...
    defaultMessage:
      '!!!You have verified the recovery phrase for this wallet. You can use it at any time to recover the funds in this wallet on another computer, even if using a different version of Klarity.',
    description:
