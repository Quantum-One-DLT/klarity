...
export const messages: { [string]: ReactIntlMessage } = defineMessages({
  ...
  undelegateWalletWarning: {
    ...
    defaultMessage:
      '!!!If you are planning to stop using this wallet and remove all funds, you should first undelegate it to recover your 2 bcc deposit. You will continue getting delegation rewards during the three Bcc epochs after undelegating your wallet.',
  ...
  delegateWalletWarning: {
    ...
    defaultMessage:
      "!!!This wallet is not delegated. Please, delegate the stake from this wallet to earn rewards and support the Bcc network's security.",
  ...
  deleteWalletWarning1: {
    ...
    defaultMessage:
      '!!!Once you delete this wallet it will be removed from the Klarity interface and you will lose access to any remaining funds in the wallet. The only way to regain access after deletion is by restoring it using your wallet recovery phrase.',
