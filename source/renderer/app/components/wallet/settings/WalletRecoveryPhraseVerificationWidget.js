...
export const messages = defineMessages({
  ...
  paperWalletDescription: {
    ...
    defaultMessage:
      '!!!If this wallet was restored from a paper wallet certificate, you cannot use this feature to verify your wallet recovery phrase. Paper wallet recovery phrase to regular wallet recovery phrase conversion will be available in Klarity soon.',
    description:
