...
export const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      '!!!This wallet contains <b>{formattedWalletAmount} BCC</b> on <b>{walletUtxosAmount} UTXOs</b> (unspent transaction outputs). Examine the histogram below to see the distribution of UTXOs with different amounts of bcc.',
  ...
  findOutMoreLinkUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/360034118013',
...
export default class WalletUtxo extends Component<Props, State> {
  ...
  render() {
    ...
    const formattedWalletAmount = walletAmount.toFormat(DECIMAL_PLACES_IN_BCC);
