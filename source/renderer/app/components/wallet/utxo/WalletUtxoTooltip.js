...
export const messages = defineMessages({
  tooltipFirst: {
    ...
    defaultMessage:
      '!!!<b>{walletUtxosAmount}</b> UTXOs containing <br /> <b>{walletAmount}</b> BCC',
    description: 'Tooltip for the "Wallet Utxos - first bar" screen.',
  },
  tooltip: {
    id: 'wallet.settings.utxos.tooltip',
    defaultMessage:
      '!!!<b>{walletUtxosAmount}</b> UTXOs containing <br /> <span> between <b>{previousWalletAmount}</b> and </span> <b>{walletAmount}</b> BCC',
