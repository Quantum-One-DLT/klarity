...
export default defineMessages({
  ...
  bccAmountLabel: {
    id: 'wallet.send.form.asset.bccLabel',
    defaultMessage: '!!!Bcc',
    description: 'Label for the "Bcc" input in the wallet send form.',
  },
  removeLabel: {
  ...
  ofLabel: {
    ...
    defaultMessage: '!!!of',
    description: 'Label for the "of" max BCC value in the wallet send form.',
  },
  minBccRequired: {
    id: 'wallet.send.form.minBccRequired',
    defaultMessage: '!!!a minimum of {minimumBcc} BCC required',
    description:
      'Label for the min BCC required value in the wallet send form.',
  },
  minBccRequiredWithAssetTooltip: {
    id: 'wallet.send.form.minBccRequiredWithAssetTooltip',
    defaultMessage:
      '!!!This transaction requires a minimum of {minimumBcc} BCC to be sent.',
    description:
      'Tooltip for the min BCC required value in the wallet send form.',
  },
  minBccRequiredWithNoAssetTooltip: {
    id: 'wallet.send.form.minBccRequiredWithNoAssetTooltip',
    defaultMessage:
      '!!!A minimum of {minimumBcc} BCC needs to be sent with every transaction.',
    description:
      'Tooltip for the min BCC required value in the wallet send form.',
  },
  descriptionLabel: {
