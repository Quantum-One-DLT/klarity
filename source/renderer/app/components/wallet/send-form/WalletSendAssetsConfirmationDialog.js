  ...
  render() {
    ...
    return (
      ...
      >
              ...
              <div className={styles.receiverRowItemAddresses}>
                ...
                <div className={styles.assetsWrapper}>
                  ...
                  <div className={styles.assetsContainer}>
                    <h3>
                      <span>{intl.formatMessage(globalMessages.bccName)}</span>
                    </h3>
                    <div className={styles.amountFeesWrapper}>
                      <div className={styles.amount}>
                        {amount} {intl.formatMessage(globalMessages.bccUnit)}
                      </div>
                    </div>
                  </div>
        ...
        {SHOW_TOTAL_AMOUNT ? (
          <>
            <div className={styles.bccAmountFeesWrapper}>
              <div className={styles.bccAmountWrapper}>
                <div className={styles.bccAmountLabel}>
                  {intl.formatMessage(messages.amountLabel)}
                </div>
                <div className={styles.bccAmount}>
                  {amount}
                  <span>
