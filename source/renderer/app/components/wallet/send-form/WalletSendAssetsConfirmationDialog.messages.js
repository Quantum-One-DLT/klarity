...
export const getMessages = () => {
  const messages: { [string]: ReactIntlMessage } = defineMessages({
    ...
    flightCandidateWarning: {
      ...
      defaultMessage:
        '!!!{Warning}, flight candidate versions of Klarity are connected to Bcc mainnet. If you confirm this transaction, your bcc will be sent for real.',
      description:
    ...
    flightCandidateCheckboxLabel: {
      ...
      defaultMessage:
        '!!!I understand that real bcc will be moved as part of this transaction and that this action is irreversible.',
      description:
    ...
    unformattedAmountMessageForHardwareWallets: {
      ...
      defaultMessage:
        '!!!Native assets may specify a number of decimal places, as defined in the Bcc token registry. Klarity uses this information to format the amount that is being sent in the transaction.<br /><br />The native token unformatted amount is the amount without these decimal places. Please ensure that you verify both amounts, as some wallet software may not yet use the Bcc token registry.<br /><br />The native token unformatted amount will be displayed on the hardware wallet device during transaction confirmation.',
      description: 'Message for "unformated amount"',
    },
    emptyingWarning: {
      id: 'wallet.send.confirmationDialog.emptyingWarning',
      defaultMessage:
        "!!!Warning: This transaction will reduce your wallet's balance to less than 2 bcc. Your wallet's balance should always be over 2 bcc to spend future staking rewards.",
      description:
