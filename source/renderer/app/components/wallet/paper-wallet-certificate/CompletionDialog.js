...
const messages = defineMessages({
  ...
  linkInstructions: {
    ...
    defaultMessage: `!!!When you wish to import your wallet back into Klarity crop any glued edges of the certificate to open it.
  ...
  bccLinkLabel: {
    id: 'paper.wallet.create.certificate.completion.dialog.bccLinkLabel',
    defaultMessage: '!!!Bcc explorer link',
    description:
      '"Paper wallet create certificate completion dialog" bcc link label.',
  },
  addressCopiedLabel: {
...
export default class CompletionDialog extends Component<Props, State> {
  ...
  render() {
    ...
    const bccExplorerLink = `${getNetworkExplorerUrl(
      network
        ...
        <div className={styles.completionContentWrapper}>
          ...
          <div className={styles.linkInstructionsWrapper}>
            ...
            <p className={styles.infoBoxLabel}>
              {intl.formatMessage(messages.bccLinkLabel)}
            </p>

            <div className={styles.infoBox}>
              <Link
                className={styles.link}
                onClick={() => onOpenExternalLink(bccExplorerLink)}
                label={bccExplorerLink}
                skin={LinkSkin}
              />
            </div>
          </div>
