...
const messages = defineMessages({
  ...
  instructionsListDefinition4: {
    ...
    defaultMessage: `!!!Your paper wallet will be offline so will not be held in Klarity.
  ...
  bccExplorer: {
    id: 'paper.wallet.create.certificate.instructions.dialog.bccExplorer',
    defaultMessage: '!!!Bcc Explorer',
    description:
      'Wallet certificate create instructions dialog "Bcc Explorer" label',
  },
  printButtonLabel: {
...
export default class InstructionsDialog extends Component<Props> {
  ...
  render() {
    ...
    const bccExplorerLink = (
      <Link
        className={styles.link}
        onClick={openNetworkExplorer}
        label={intl.formatMessage(messages.bccExplorer)}
        skin={LinkSkin}
      />
    );
