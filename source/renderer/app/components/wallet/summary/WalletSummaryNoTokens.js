...
const messages = defineMessages({
  ...
  learnMoreTextBottom: {
    ...
    defaultMessage: '!!!Start by visiting the TBCO blog for a useful primer.',
    description: '"Learn more" text in the Wallets Summary No Tokens component',
  },
  learnMoreLinkLabel: {
  ...
  learnMoreLinkUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.io/en/blog/posts/2021/02/04/native-tokens-to-bring-new-utility-to-life-on-bcc/',
    description:
