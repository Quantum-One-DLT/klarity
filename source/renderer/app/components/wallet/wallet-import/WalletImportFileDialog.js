...
const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      '!!!<p>This feature enables you to import wallets from the production version of Klarity, or from the Klarity state directory. </p> <p>If you don’t have the complete state directory, then you will need either the ‘Secrets’ or ‘Secrets-1.0’ folder containing the ‘secret.key’ file to be able to import a wallet, although without the complete state directory Klarity won’t be able to detect your wallet names. </p> <p>If you don’t have either the ‘Secrets’ or the ‘Secrets-1.0’ folder containing the ‘secret.key’ file, then you cannot import wallets using this feature.</p>',
    description:
      '<p>This feature enables you to import wallets from the production version of Klarity, or from the Klarity state directory. </p> <p>If you don’t have the complete state directory, then you will need either the ‘Secrets’ or ‘Secrets-1.0’ folder containing the ‘secret.key’ file to be able to import a wallet, although without the complete state directory Klarity won’t be able to detect your wallet names. </p> <p>If you don’t have either the ‘Secrets’ or the ‘Secrets-1.0’ folder containing the ‘secret.key’ file, then you cannot import wallets using this feature.</p>',
  },
  stateFolderLabel: {
    id: 'wallet.import.file.dialog.stateFolderLabel',
    defaultMessage: '!!!Select Klarity state folder:',
    description: 'Select Klarity state folder:',
  },
  secretFileLabel: {
    id: 'wallet.import.file.dialog.secretFileLabel',
    defaultMessage: "!!!Select Klarity 'secret.key' file:",
    description: "Select Klarity 'secret.key' file:",
  },
  buttonLabel: {
  ...
  stateDirNoWallets: {
    ...
    defaultMessage:
      '!!!No wallets found. Make sure you have selected a Klarity state directory which contains the ‘Secrets’ or `Secrets-1.0` folder with a `secret.key` file inside.',
    description:
      'No wallets found. Make sure you have selected a Klarity state directory which contains the ‘Secrets’ or `Secrets-1.0` folder with a `secret.key` file inside.',
  },
  secretFileNoWallets: {
  ...
  linkUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/900000623463',
  ...
  secretFileOptionLabel: {
    ...
    defaultMessage: "!!!Klarity 'secret.key' file",
    description: "Klarity 'secret.key' file",
  },
});
