...
const messages = defineMessages({
  ...
  description: {
    ...
    defaultMessage:
      '!!!These wallets were found in your Klarity state directory.<p>Please select the wallets you want to import.</p>',
    description:
      'These wallets were found in your Klarity state directory. Please select the wallets you want to import.',
  },
  unamedWalletsTitle: {
  ...
  maxWalletsReachedTooltip: {
    ...
    defaultMessage:
      '!!!Klarity supports up to {maxWalletsCount} wallets. You will need to remove another wallet before you can import this one.',
...
type Props = {
  ...
  exportedWallets: Array<ExportedColeWallet>,
...
export default class WalletSelectImportDialog extends Component<Props> {
  ...
  getWalletStatus = (wallet: ExportedColeWallet) => {
  ...
  getWalletStatusIcon = (wallet: ExportedColeWallet, index: number) => {
    const {
      nameValidator,
            ...
            content={
              invalidWalletName ? (
                ...
                <FormattedMessage
                  ...
                  values={{
                    maxWalletsCount: MAX_BCC_WALLETS_COUNT,
                  }}
                />
              )
            }
  ...
  render() {
    ...
    const walletsWithNames = exportedWallets.filter(
      ({ hasName }: ExportedColeWallet) => hasName
    );
