...
const messages = defineMessages({
  ...
  leftoversLearnMoreUrl: {
    ...
    defaultMessage: '!!!https://tbco.zendesk.com/hc/en-us/articles/',
    description: 'Label Leftovers in the transfer funds form',
  },
  buttonLabel: {
...
export default class TransferFundsStep2Dialog extends Component<Props> {
  ...
  render() {
    ...
    const fees = feesAmount.toFormat(DECIMAL_PLACES_IN_BCC);
    const leftovers =
      leftoversAmount && !leftoversAmount.isZero()
        ? leftoversAmount.toFormat(DECIMAL_PLACES_IN_BCC)
        : null;
