...
const messages = defineMessages({
  ...
  supportArticleUrl: {
    ...
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/360038113814',
  ...
  unresolvedInputAddressesLinkLabel: {
    ...
    defaultMessage: '!!!Open this transaction in Bcc explorer',
  ...
  cancelFailedTxnNote: {
    ...
    defaultMessage:
      '!!!This transaction was submitted to the Bcc network, but it expired, so it failed. Transactions on the Bcc network have a ‘time to live’ attribute, which passed before the network processed the transaction. Please, remove it to release the funds (UTXOs) used by this transaction to use those funds in another transaction.',
              ...
              <div className={styles.header}>
                ...
                {data.amount && (
                  <div className={styles.amount}>
                    ...
                    <span>{intl.formatMessage(globalMessages.bccUnit)}</span>
                  </div>
                )}
              </div>
