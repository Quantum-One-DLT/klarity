...
const messages = defineMessages({
  moveFundsTitle: {
    id: 'wallet.cole.notification.moveFundsTitle',
    defaultMessage: '!!!Move funds from {activeWalletName}',
    description:
      'Title "Move funds from the legacy wallet" on the legacy notification.',
  },
  addWalletTitle: {
    id: 'wallet.cole.notification.addWalletTitle',
    defaultMessage: '!!!Create a Sophie wallet',
    description: 'Title "Create a Sophie wallet" on the legacy notification.',
  },
  moveFundsDescriptionLine1: {
    id: 'wallet.cole.notification.moveFundsDescription.line1',
    defaultMessage:
      '!!!"{activeWalletName}"" is a Cole legacy wallet that does not support Sophie delegation features. To earn bcc from delegating your stake, please move all funds from this wallet to a new wallet that is Sophie-compatible.',
    description: 'Legacy notification description.',
  },
  moveFundsDescriptionLine2: {
    id: 'wallet.cole.notification.moveFundsDescription.line2',
    defaultMessage:
      '!!!You can create a {moveFundsLink} or move funds to one of your existing wallets.',
    description: 'Legacy notification description.',
  },
  moveFundsLinkLabel: {
    id: 'wallet.cole.notification.moveFundsDescription.line2.link.label',
  ...
  descriptionWithFunds: {
    ...
    defaultMessage:
      '!!!"{transferWalletName}"" is a legacy wallet. It does not support Sophie delegation features. To earn bcc from delegating your stake, please move all funds from this wallet to a new, Sophie-compatible wallet. You can create a brand new wallet or move funds to one of the existing wallets.',
    description: 'Legacy notification description WithFunds.',
  },
  addWalletDescriptionLine1: {
    id: 'wallet.cole.notification.addWalletDescription.line1',
    defaultMessage:
      '!!!"{activeWalletName}"" is a Cole legacy wallet that does not support Sophie delegation features. To earn bcc from delegating your stake, please move all funds from this wallet to a new wallet that is Sophie-compatible.',
    description: 'Legacy notification description.',
  },
  addWalletDescriptionLine2: {
    id: 'wallet.cole.notification.addWalletDescription.line2',
    defaultMessage:
      '!!!Since all of your wallets are Cole legacy wallets you will first need to create a new Sophie wallet.',
    description: 'Legacy notification description.',
  },
  actionLearnMore: {
    id: 'wallet.cole.notification.actionLearnMore',
    defaultMessage: '!!!Learn more',
    description: 'Learn more action of legacy notification.',
  },
  actionMove: {
    id: 'wallet.cole.notification.actionMove',
    defaultMessage: '!!!Move bcc to an existing wallet',
    description: 'Move Move bcc from this wallet of legacy notification.',
  },
  addWallet: {
    id: 'wallet.cole.notification.addWallet',
    defaultMessage: '!!!Create a new wallet',
    description: 'Create a new wallet action of legacy notification.',
  },
  learnMoreLinkUrl: {
    id: 'wallet.cole.notification.learnMore.url',
    defaultMessage:
      '!!!https://tbco.zendesk.com/hc/en-us/articles/360038726373',
