...
import { klarityTheme } from './themes/klarity';
import { themeOverrides } from './themes/overrides';
import translations from './i18n/translations';
import ThemeManager from './ThemeManager';
import AboutDialog from './containers/static/AboutDialog';
import KlarityDiagnosticsDialog from './containers/status/KlarityDiagnosticsDialog';
...
export default class App extends Component<{
  ...
  render() {
    ...
    const themeVars = require(`./themes/klarity/${currentTheme}.js`).default;
    const { ABOUT, KLARITY_DIAGNOSTICS } = DIALOGS;

    const canShowNews =
      !isSetupPage && // Active page is not "Language Selection" or "Terms of Use"
      !isNodeStopping && // Klarity is not shutting down
      !isNodeStopped; // Klarity is not shutting down
            ...
            >
              <Fragment>
                ...
                {[
                  ...
                  isActiveDialog(KLARITY_DIAGNOSTICS) && (
                    <KlarityDiagnosticsDialog key="klarityDiagnosticsDialog" />
                  ),
