...
export default defineMessages({
  ...
  bccUnit: {
    id: 'global.bcc.unit',
    defaultMessage: '!!!BCC',
    description: '"BCC" unit',
  },
  currency: {
    id: 'environment.currency.bcc',
    defaultMessage: '!!!BCC',
    description: 'Name for "Bcc" unit.',
  },
  fieldIsRequired: {
  ...
  apiName: {
    id: 'environment.apiName.bcc',
    defaultMessage: '!!!Bcc',
    description: 'Name for "Bcc" client.',
  },
  network_mainnet: {
    id: 'environment.network.mainnet',
    defaultMessage: '!!!Mainnet',
    description: '"mainnet" Bcc network',
  },
  network_staging: {
    id: 'environment.network.staging',
    defaultMessage: '!!!Staging',
    description: '"staging" Bcc network',
  },
  network_testnet: {
    id: 'environment.network.testnet',
    defaultMessage: '!!!Testnet',
    description: '"testnet" Bcc network',
  },
  network_sophie_qa: {
    id: 'environment.network.sophie_qa',
    defaultMessage: '!!!Sophie QA',
    description: '"Sophie QA" Bcc network',
  },
  network_aurum_purple: {
    id: 'environment.network.aurum_purple',
    defaultMessage: '!!!Aurum Purple',
    description: '"Aurum Purple" Bcc network',
  },
  network_development: {
    id: 'environment.network.development',
    defaultMessage: '!!!Development',
    description: '"development" Bcc network',
  },
  network_selfnode: {
    id: 'environment.network.selfnode',
    defaultMessage: '!!!Selfnode',
    description: '"selfnode" Bcc network',
  },
  years: {
  ...
  featureUnavailableWhileSyncing: {
    ...
    defaultMessage:
      '!!!Klarity is synchronizing with the Bcc blockchain, and the process is currently <b>{syncPercentage}%</b> complete. This feature will become available once Klarity is fully synchronized.',
    description:
      'Info message displayed for features which are unavailable while Klarity is syncing',
  },
