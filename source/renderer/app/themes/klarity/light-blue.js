...
//  ==== light-blue theme output for Klarity and react-polymorph components === //
export const LIGHT_BLUE_THEME_OUTPUT = {
  ...
  icon: {
    ...
    '--theme-icon-connecting-bcc-api-logo-color': '#fafbfc',
    '--theme-icon-connecting-bcc-logo-color': '#fafbfc',
    '--theme-icon-connecting-klarity-logo-color': '#fafbfc',
