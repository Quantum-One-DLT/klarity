...
//  ==== bcc theme output for Klarity and react-polymorph components === //
export const BCC_THEME_OUTPUT = {
  aboutWindow: {
    '--theme-about-window-background-color': 'rgba(32, 34, 37, 0.96)',
    '--theme-about-window-header-bottom-border-color':
      'rgba(233, 244, 254, 0.3)',
    '--theme-about-window-klarity-icon-color': '#e9f4fe',
    '--theme-about-window-bcc-icon-color': '#e9f4fe',
  ...
  icon: {
    ...
    '--theme-icon-bcc-summary-wallet-amount-symbol-color': '#5e6066',
    ...
    '--theme-icon-syncing-bcc-api-logo-color': '#5e6066',
    '--theme-icon-syncing-bcc-logo-color': '#5e6066',
    '--theme-icon-syncing-klarity-logo-color': '#5e6066',
    '--theme-icon-transactions-bcc-symbol-color': '#5e6066',
  ...
  staking: {
    ...
    '--theme-staking-wallet-row-ticker-bcc-icon-fill-color': '#5e606680',
...
const BCC_THEME_PARAMS: CreateThemeParams = {
  config: BCC_THEME_OUTPUT,
};

export default createTheme(BCC_THEME_PARAMS);
