...
//  ==== dark-blue theme output for Klarity and react-polymorph components === //
export const DARK_BLUE_THEME_OUTPUT = {
  ...
  icon: {
    ...
    '--theme-icon-bcc-summary-wallet-amount-symbol-color': '#e9f4fe',
    ...
    '--theme-icon-syncing-bcc-api-logo-color': '#e9f4fe',
    '--theme-icon-syncing-bcc-logo-color': '#e9f4fe',
    '--theme-icon-syncing-klarity-logo-color': '#e9f4fe',
    '--theme-icon-transactions-bcc-symbol-color': '#e9f4fe',
  ...
  staking: {
    ...
    '--theme-staking-wallet-row-ticker-bcc-icon-fill-color': '#e9f4fe80',
