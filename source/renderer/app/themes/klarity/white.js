...
//  ==== white theme output for Klarity and react-polymorph components === //
export const WHITE_THEME_OUTPUT = {
  aboutWindow: {
    ...
    '--theme-about-window-klarity-icon-color': '#29b595',
    '--theme-about-window-bcc-icon-color': '#29b595',
  ...
  icon: {
    ...
    '--theme-icon-syncing-klarity-logo-color': '#29b595',
