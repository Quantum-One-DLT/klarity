...
//  ==== yellow theme output for Klarity and react-polymorph components === //
export const YELLOW_THEME_OUTPUT = {
  aboutWindow: {
    ...
    '--theme-about-window-klarity-icon-color': '#2d2d2d',
    '--theme-about-window-bcc-icon-color': '#2d2d2d',
  ...
  icon: {
    ...
    '--theme-icon-bcc-summary-wallet-amount-symbol-color': '#2d2d2d',
    ...
    '--theme-icon-connecting-bcc-api-logo-color': '#2d2d2d',
    '--theme-icon-connecting-bcc-logo-color': '#2d2d2d',
    '--theme-icon-connecting-klarity-logo-color': '#2d2d2d',
    '--theme-icon-copy-address-color': '#2d2d2d',
    '--theme-icon-delegation-center-no-wallets': '#2d2d2d',
    '--theme-icon-file-upload-color': '#2d2d2d',
    '--theme-icon-syncing-bcc-api-logo-color': '#2d2d2d',
    '--theme-icon-syncing-bcc-logo-color': '#2d2d2d',
    '--theme-icon-syncing-klarity-logo-color': '#2d2d2d',
    '--theme-icon-transactions-bcc-symbol-color': '#2d2d2d',
  ...
  staking: {
    ...
    '--theme-staking-wallet-row-ticker-bcc-icon-fill-color': '#2d2d2d80',
