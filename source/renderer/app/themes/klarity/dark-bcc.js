...
//  ==== dark-bcc theme output for Klarity and react-polymorph components === //
export const DARK_BCC_THEME_OUTPUT = {
  aboutWindow: {
...
const DARK_BCC_THEME_PARAMS: CreateThemeParams = {
  config: DARK_BCC_THEME_OUTPUT,
};

export default createTheme(DARK_BCC_THEME_PARAMS);
