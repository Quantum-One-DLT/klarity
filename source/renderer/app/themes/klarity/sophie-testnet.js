...
//  ==== sophie-testnet theme output for Klarity and react-polymorph components === //
export const SOPHIE_TESTNET_THEME_OUTPUT = {
  aboutWindow: {
    '--theme-about-window-background-color': '#36374df5',
    '--theme-about-window-header-bottom-border-color': '#ffffff4d',
    '--theme-about-window-klarity-icon-color': '#ffffff',
    '--theme-about-window-bcc-icon-color': '#ffffff',
  ...
  icon: {
    ...
    '--theme-icon-bcc-summary-wallet-amount-symbol-color': '#ffffff',
    '--theme-icon-add-wallet-dialog-big-button-color':
      'rgba(255, 255, 255, 0.5)',
    '--theme-icon-back-button-color': '#ffffff',
    '--theme-icon-close-button-color': '#ffffff',
    '--theme-icon-connecting-bcc-api-logo-color': '#ffffff',
    '--theme-icon-connecting-bcc-logo-color': '#ffffff',
    '--theme-icon-connecting-klarity-logo-color': '#ffffff',
    '--theme-icon-copy-address-color': '#ffffff',
    '--theme-icon-delegation-center-no-wallets': '#ffffff',
    '--theme-icon-file-upload-color': '#ffffff',
    '--theme-icon-syncing-bcc-api-logo-color': '#ffffff',
    '--theme-icon-syncing-bcc-logo-color': '#ffffff',
    '--theme-icon-syncing-klarity-logo-color': '#ffffff',
    '--theme-icon-transactions-bcc-symbol-color': '#ffffff',
  ...
  staking: {
    ...
    '--theme-staking-wallet-row-ticker-bcc-icon-fill-color': '#ffffff80',
...
const SOPHIE_TESTNET_THEME_PARAMS: CreateThemeParams = {
  config: SOPHIE_TESTNET_THEME_OUTPUT,
};

export default createTheme(SOPHIE_TESTNET_THEME_PARAMS);
