...
- Fixed visual glitch on the transaction list switching between filters ([PR 2249](https://github.com/The-Blockchain-Company/klarity/pull/2249))
...
- Added handlers for new error messages ([PR 2090](https://github.com/The-Blockchain-Company/klarity/pull/2090))
...
- Ranked stake pools based on delegated amount configured by slider ([PR 2051](https://github.com/The-Blockchain-Company/klarity/pull/2051), [PR 2063](https://github.com/The-Blockchain-Company/klarity/pull/2063), [PR 2072](https://github.com/The-Blockchain-Company/klarity/pull/2072))
...
- Updated `bcc-wallet` to revision `254575e4` which includes Jormungandr 0.8.6 ([PR 1821](https://github.com/The-Blockchain-Company/klarity/pull/1821))
...
- Fixed naming of labels on "Klarity Diagnostics" screen and status icons on "Loading" screen from "Node..." to "Bcc node..." ([PR 1723](https://github.com/The-Blockchain-Company/klarity/pull/1723))
...
- Updated `bcc-wallet` to revision `833f9d4e` which includes Jormungandr 0.8.0-rc7 ([PR 1739](https://github.com/The-Blockchain-Company/klarity/pull/1739))
...
- Added the Bcc Explorer URL's for ITN ([PR 1674](https://github.com/The-Blockchain-Company/klarity/pull/1674))
...
- Implemented detection of system locale during Klarity startup ([PR 1348](https://github.com/The-Blockchain-Company/klarity/pull/1348))
...
- "Delegation" screens UI:
  ...
  - Implemented "Epochs" screen UI ([PR 1418](https://github.com/The-Blockchain-Company/klarity/pull/1418))
...
- Replaced in-app support request with links to support page ([PR 1199](https://github.com/The-Blockchain-Company/klarity/pull/1199), [PR 1331](https://github.com/The-Blockchain-Company/klarity/pull/1331))
...
- Added support for newly introduced `UtxoNotEnoughFragmented` API error message ([PR 1297](https://github.com/The-Blockchain-Company/klarity/pull/1297))
...
- Implemented "Forbidden mnemonic" error message ([PR 1093](https://github.com/The-Blockchain-Company/klarity/pull/1093), [PR 1100](https://github.com/The-Blockchain-Company/klarity/pull/1100))
- Implemented extended error messages for transaction fee calculation failures ([PR 1111](https://github.com/The-Blockchain-Company/klarity/pull/1111))
- Implemented forms submission on "Enter" key press ([PR 981](https://github.com/The-Blockchain-Company/klarity/pull/981))
- Implemented Japanese "Terms of use" for the "Testnet" network ([PR 1097](https://github.com/The-Blockchain-Company/klarity/pull/1097))
- Implemented lock-file mechanism which prevents multiple Klarity instances from running against the same state directory and network ([PR 1113](https://github.com/The-Blockchain-Company/klarity/pull/1113), [PR 1114](https://github.com/The-Blockchain-Company/klarity/pull/1114), [PR 1121](https://github.com/The-Blockchain-Company/klarity/pull/1121), [PR 1166](https://github.com/The-Blockchain-Company/klarity/pull/1166))
- Implemented "New data layer migration" screen ([PR 1096](https://github.com/The-Blockchain-Company/klarity/pull/1096))
- Implemented sending of `cert` and `key` with API requests in order to enable 2-way TLS authentication ([PR 1072](https://github.com/The-Blockchain-Company/klarity/pull/1072))
- Implemented support for Bcc node "structured logging" ([PR 1092](https://github.com/The-Blockchain-Company/klarity/pull/1092), [PR 1122](https://github.com/The-Blockchain-Company/klarity/pull/1122))
- Implemented the IPC driven Bcc node / Klarity communication ([PR 1075](https://github.com/The-Blockchain-Company/klarity/pull/1075), [PR 1107](https://github.com/The-Blockchain-Company/klarity/pull/1107), [PR 1109](https://github.com/The-Blockchain-Company/klarity/pull/1109), [PR 1115](https://github.com/The-Blockchain-Company/klarity/pull/1115), [PR 1118](https://github.com/The-Blockchain-Company/klarity/pull/1118), [PR 1119](https://github.com/The-Blockchain-Company/klarity/pull/1119), [PR 1162](https://github.com/The-Blockchain-Company/klarity/pull/1162))
- Improved the loading UX ([PR 723](https://github.com/The-Blockchain-Company/klarity/pull/723))
- Improved the NTP check handling ([PR 1086](https://github.com/The-Blockchain-Company/klarity/pull/1086), [PR 1149](https://github.com/The-Blockchain-Company/klarity/pull/1149), [PR 1158](https://github.com/The-Blockchain-Company/klarity/pull/1158), [PR 1194](https://github.com/The-Blockchain-Company/klarity/pull/1194), [PR 1213](https://github.com/The-Blockchain-Company/klarity/pull/1213))
- Improved the transaction details text selection ([PR 1073](https://github.com/The-Blockchain-Company/klarity/pull/1073), [PR 1095](https://github.com/The-Blockchain-Company/klarity/pull/1095))
- Integrated Bcc V1 API endpoints ([PR 1018](https://github.com/The-Blockchain-Company/klarity/pull/1018), [PR 1031](https://github.com/The-Blockchain-Company/klarity/pull/1031), [PR 1037](https://github.com/The-Blockchain-Company/klarity/pull/1037), [PR 1042](https://github.com/The-Blockchain-Company/klarity/pull/1042), [PR 1045](https://github.com/The-Blockchain-Company/klarity/pull/1045), [PR 1070](https://github.com/The-Blockchain-Company/klarity/pull/1070), [PR 1078](https://github.com/The-Blockchain-Company/klarity/pull/1078), [PR 1079](https://github.com/The-Blockchain-Company/klarity/pull/1079), [PR 1080](https://github.com/The-Blockchain-Company/klarity/pull/1080), [PR 1088](https://github.com/The-Blockchain-Company/klarity/pull/1088), [PR 1220](https://github.com/The-Blockchain-Company/klarity/pull/1220))
- Refactored and improved `NetworkStatus` store to use V1 API data ([PR 1081](https://github.com/The-Blockchain-Company/klarity/pull/1081))

### Fixes

- Added support for non-Latin characters in spending password ([PR 1196](https://github.com/The-Blockchain-Company/klarity/pull/1196))
- Fixed an issue which allowed to submit invalid form on the "Send" screen using an "enter" key ([PR 1002](https://github.com/The-Blockchain-Company/klarity/pull/1002))
- Fixed an issue which caused the send bug report form to hang and not send the support request if the logs were downloaded before attempting to send the request ([PR 1176](https://github.com/The-Blockchain-Company/klarity/pull/1176))
- Fixed an issue which would show a runtime JavaScript error in case Klarity is not started using Launcher ([PR 1169](https://github.com/The-Blockchain-Company/klarity/pull/1169))
- Fixed an issue which would trigger submission of the "Generate address" button on the "Receive" screen on right-mouse click ([PR 1082](https://github.com/The-Blockchain-Company/klarity/pull/1082))
- Fixed an issue with the "Having Trouble Connecting" notification not showing up on the "Connection lost. Reconnecting..." screen ([PR 1112](https://github.com/The-Blockchain-Company/klarity/pull/1112))
- Fixed broken "Export wallet to file" dialog and improved "Wallet settings" screen dialogs file structure and namings ([PR 998](https://github.com/The-Blockchain-Company/klarity/pull/998))
- Fixed special buttons outline color ([PR 990](https://github.com/The-Blockchain-Company/klarity/pull/990))
- Fixed the close button's hover state within the AntivirusRestaurationSlowdownNotification so it's full height ([PR 1131](https://github.com/The-Blockchain-Company/klarity/pull/1131))
- Fixed uninstaller unicode issue ([PR 1116](https://github.com/The-Blockchain-Company/klarity/pull/1116))
- Fixed window icon quality issue on Linux ([PR 1170](https://github.com/The-Blockchain-Company/klarity/pull/1170))
- Implement design review fixes and improvements ([PR 1090](https://github.com/The-Blockchain-Company/klarity/pull/1090))
- Pinned eslint-scope version via the yarn resolutions feature ([PR 1017](https://github.com/The-Blockchain-Company/klarity/pull/1017))
- Prevented wallet data polling during wallet deletion ([PR 996](https://github.com/The-Blockchain-Company/klarity/pull/996))
- Removed transaction status and number of confirmation during wallet restoration ([PR 1189](https://github.com/The-Blockchain-Company/klarity/pull/1189))

### Chores

- Added acceptance tests for node update notification with apply and postpone update scenarios ([PR 977](https://github.com/The-Blockchain-Company/klarity/pull/977))
- Added acceptance tests for maximum wallets limit ([PR 979](https://github.com/The-Blockchain-Company/klarity/pull/979))
- Added acceptance tests for the "About" dialog ([PR 975](https://github.com/The-Blockchain-Company/klarity/pull/975))
- Added acceptance tests for wallets, transactions and addresses ordering ([PR 976](https://github.com/The-Blockchain-Company/klarity/pull/976))
- Added Klarity and Bcc version to Klarity log ([PR 1094](https://github.com/The-Blockchain-Company/klarity/pull/1094), [PR 1137](https://github.com/The-Blockchain-Company/klarity/pull/1137))
- Added dynamic prefix derivation to local storage keys used to store previous Bcc node PID and added dynamic derivation of Bcc node process names based on the current platform ([PR 1109](https://github.com/The-Blockchain-Company/klarity/pull/1109))
- Added logging of "GPU-crashed" events ([PR 1083](https://github.com/The-Blockchain-Company/klarity/pull/1083))
- Added `NETWORK` info to the application title bar ([PR 1174](https://github.com/The-Blockchain-Company/klarity/pull/1174))
- Added screenshot recording of failed acceptance tests ([PR 1103](https://github.com/The-Blockchain-Company/klarity/pull/1103))
- Added Storybook stories for the wallet screens ([942](https://github.com/The-Blockchain-Company/klarity/pull/942))
- Disabled logging to `bcc-node.log` since it was not needed for the support and it was impacting performance ([PR 1027](https://github.com/The-Blockchain-Company/klarity/pull/1027))
- Enabled Bcc node EKG for non-mainnet networks and made it accessible from the "Network status" screen ([PR 1188](https://github.com/The-Blockchain-Company/klarity/pull/1188))
- Fixated all `npm` dependencies and update script names ([PR 1014](https://github.com/The-Blockchain-Company/klarity/pull/1014))
- Fixed broken storybook ([PR 1041](https://github.com/The-Blockchain-Company/klarity/pull/1041))
- Improved compress/download logs handling ([PR 995](https://github.com/The-Blockchain-Company/klarity/pull/995))
- Integrated latest React-Polymorph features: render props architecture, theme composition, and a ThemeProvider HOC ([PR 950](https://github.com/The-Blockchain-Company/klarity/pull/950))
- Integrated latest React-Polymorph with a fix for `NumericInput` component carrot positioning issues ([PR 1172](https://github.com/The-Blockchain-Company/klarity/pull/1172))
- Made `nodelLogPath` entry in `launcher-config.yaml` optional ([PR 1027](https://github.com/The-Blockchain-Company/klarity/pull/1027))
- Made `port` and `ca` of Bcc Api configurable during runtime ([PR 1067](https://github.com/The-Blockchain-Company/klarity/pull/1067))
- Removed all ETC specific files ([PR 1068](https://github.com/The-Blockchain-Company/klarity/pull/1068), [PR 1108](https://github.com/The-Blockchain-Company/klarity/pull/1108))
- Removed Wallet `export` and `import` features for the "Testnet" network ([PR 1168](https://github.com/The-Blockchain-Company/klarity/pull/1168))
- Switched from `npm` to `yarn` ([PR 989](https://github.com/The-Blockchain-Company/klarity/pull/989))

## 0.11.2

### Fixes

- Update Bcc SL revision to version `1.3.2` ([PR 1181](https://github.com/The-Blockchain-Company/klarity/pull/1181))

## 0.11.1

### Features

- Added support for configurable Api port ([PR 992](https://github.com/The-Blockchain-Company/klarity/pull/992))
- Added initial configuration for a testnet build of Klarity ([PR 991](https://github.com/The-Blockchain-Company/klarity/pull/991))

### Fixes

- Changed the information we are sending on support requests to the reporting server ([PR 1036](https://github.com/The-Blockchain-Company/klarity/pull/1036))
- Fixed an issue on Windows where Klarity couldn't start if the Windows username contained non-ASCII characters ([PR 1057](https://github.com/The-Blockchain-Company/klarity/pull/1057))
- Fixed a issue with Electron which results in blank/white screen rendering on some OS/Graphics-card/Drivers combinations ([PR 1007](https://github.com/The-Blockchain-Company/klarity/pull/1007))
- Fixed Klarity icon scaling issues on Windows ([PR 1064](https://github.com/The-Blockchain-Company/klarity/pull/1064))
- Implemented error dialog shown in case Klarity is not started using Launcher ([PR 1054](https://github.com/The-Blockchain-Company/klarity/pull/1054))
- Improved paper wallet certificate QR code compatibility ([PR 999](https://github.com/The-Blockchain-Company/klarity/pull/999))
- Updated to `electon@1.7.16` to avoid the known vulnarability [CVE-2018-15685](https://cve.mitre.org/cgi-bin/cvename.cgi?name=CVE-2018-15685) ([PR 1066](https://github.com/The-Blockchain-Company/klarity/pull/1066))

### Chores

- Implemented `NETWORK` specific Bcc Blockchain Explorer links (Mainnet, Testnet, Staging) ([PR 1051](https://github.com/The-Blockchain-Company/klarity/pull/1051))
- Improved network label in the Top bar ([PR 988](https://github.com/The-Blockchain-Company/klarity/pull/988))
- Added "Testnet" label to paper wallet certificates which are not generated on the mainnet ([PR 1055](https://github.com/The-Blockchain-Company/klarity/pull/1055))

## 0.11.0

### Features

- Implemented a switch instead of a link for "hide used" addresses on the Receive screen ([PR 935](https://github.com/The-Blockchain-Company/klarity/pull/935))
- Added a notification for Windows users that using antivirus software might slow down wallet restoration ([PR 1020](https://github.com/The-Blockchain-Company/klarity/pull/1020))

### Fixes

- Disabled dragging of static UI images elements ([PR 910](https://github.com/The-Blockchain-Company/klarity/pull/910))
- Disabled webview tags to prevent XSS attacks ([PR 946](https://github.com/The-Blockchain-Company/klarity/pull/946))
- Fixed 633 npm audit issues by upgrading dependencies ([PR 944](https://github.com/The-Blockchain-Company/klarity/pull/944))
- Fixed a bug related to rendering of transactions with duplicated IDs ([PR 947](https://github.com/The-Blockchain-Company/klarity/pull/947))
- Fixed broken translation on create wallet dialog ([PR 930](https://github.com/The-Blockchain-Company/klarity/pull/930))
- Fixed huge build file sizes ([PR 886](https://github.com/The-Blockchain-Company/klarity/pull/886))
- Fixed Linux Kanji characters support ([PR 971](https://github.com/The-Blockchain-Company/klarity/pull/971))
- Fixed Storybook configuration issues ([PR 928](https://github.com/The-Blockchain-Company/klarity/pull/928))
- Fixed text wrapping within wallet navigation tabs ([PR 911](https://github.com/The-Blockchain-Company/klarity/pull/911))
- Reduced resource usage ([PR 886](https://github.com/The-Blockchain-Company/klarity/pull/886))
- Refactored about window to normal UI dialog to save resources ([PR 965](https://github.com/The-Blockchain-Company/klarity/pull/965))
- Removed mocked ETC wallet data injection in Bcc Klarity builds ([PR 955](https://github.com/The-Blockchain-Company/klarity/pull/955))
- Removed the Bcc Redemption link from the "app bar" menu and added it to system menu ([PR 972](https://github.com/The-Blockchain-Company/klarity/pull/972))

### Chores

- Added "Author" and "Status" information to all Klarity README files ([PR 901](https://github.com/The-Blockchain-Company/klarity/pull/901))
- Added acceptance tests for displaying transactions in various contexts ([PR 870](https://github.com/The-Blockchain-Company/klarity/pull/870))
- Added acceptance tests for hide/show used addresses feature ([PR 957](https://github.com/The-Blockchain-Company/klarity/pull/957))
- Added flow checks and linting for storybook code ([PR 938](https://github.com/The-Blockchain-Company/klarity/pull/938))
- Added PR template with PR review checlist ([PR 882](https://github.com/The-Blockchain-Company/klarity/pull/882))
- Fixed wallet restoration and import fragile acceptance tests steps definitions ([PR 885](https://github.com/The-Blockchain-Company/klarity/pull/885))
- Improved re-build times with caching ([PR 915](https://github.com/The-Blockchain-Company/klarity/pull/915))
- Improved request body length calculation ([PR 892](https://github.com/The-Blockchain-Company/klarity/pull/892))
- Improved text display by reducing letter-spacing ([PR 973](https://github.com/The-Blockchain-Company/klarity/pull/973))
- Log expected errors as debug messages only ([PR 916](https://github.com/The-Blockchain-Company/klarity/pull/916))
- Refactored npm scripts to use colon style ([PR 939](https://github.com/The-Blockchain-Company/klarity/pull/939))
- Refactored various magic numbers & strings into constants ([PR 881](https://github.com/The-Blockchain-Company/klarity/pull/881))

## 0.10.1

### Fixes

- Fixed issues with printing paper wallet certificate PDFs on printers with low amount of memory by replacing the SVG assets with transparent PNG images ([PR 951](https://github.com/The-Blockchain-Company/klarity/pull/951))
- Fixed presentation bug that caused only ten wallets to be shown in the wallets list, even though there were more than ten wallets in the application ([PR 958](https://github.com/The-Blockchain-Company/klarity/pull/958))
- Fixed reporting server URL used for submitting support requests for the Linux build of Klarity ([PR 959](https://github.com/The-Blockchain-Company/klarity/pull/959))
- Fixed missing launcher log file ([PR 963](https://github.com/The-Blockchain-Company/klarity/pull/963))
- Fixed issue with multiple bcc-node processes running and windows allowing skipping of files in installer ([PR 953](https://github.com/The-Blockchain-Company/klarity/pull/953))
- Limited maximum number of wallets to 20 ([PR 966](https://github.com/The-Blockchain-Company/klarity/pull/966))

## 0.10.0

### Features

- Asynchronous wallet restoration ([PR 849](https://github.com/The-Blockchain-Company/klarity/pull/849))
- Added wallet restore indicator in the sidebar ([PR 862](https://github.com/The-Blockchain-Company/klarity/pull/862))
- Added Klarity version in application title ([PR 826](https://github.com/The-Blockchain-Company/klarity/pull/826))
- Added "Show more transactions" button on the summary screen ([PR 848](https://github.com/The-Blockchain-Company/klarity/pull/848))
- Added "Recovery - regular" and "Recovery - force vended" tabs on "Bcc redemption" screen ([PR 933](https://github.com/The-Blockchain-Company/klarity/pull/933))
- Setting spending password to "ON" by default ([PR 856](https://github.com/The-Blockchain-Company/klarity/pull/856))
- Paper wallet certificate generation ([PR 779](https://github.com/The-Blockchain-Company/klarity/pull/779))
- Paper wallet certificate restoration ([PR 794](https://github.com/The-Blockchain-Company/klarity/pull/794))
- Update paper wallet certificate generation to use more random bits ([PR 871](https://github.com/The-Blockchain-Company/klarity/pull/871))

### Fixes

- Fixed color of Bcc logo color on the loading screen (logo was too transparent) ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Fixed styling of "click to upload" text on Bcc redemption screen (text was too bold) ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Fixed node syncing state bubble background color in Dark blue theme ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Fixed cropped log list within the support request dialog ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Fixed submit button flicker within the support request dialog ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Fixed "Download logs" button bug where it would throw Javascript error in case user does not select destination directory for saving logs file ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Updated moment.js dependency to the latest version which fixes ReDOS vulnerability ([PR 782](https://github.com/The-Blockchain-Company/klarity/pull/782))
- Updated Electron dependency to the latest version which fixes vulnerability issues ([PR 855](https://github.com/The-Blockchain-Company/klarity/pull/855))
- Extended About dialog size in order to display increased team members list ([PR 880](https://github.com/The-Blockchain-Company/klarity/pull/880))
- Created screen for Bcc redemption in case there are no wallets ([PR 970](https://github.com/The-Blockchain-Company/klarity/pull/970))

### Chores

- Improved build system ([PR 692](https://github.com/The-Blockchain-Company/klarity/pull/692))
- Added instructions for accessing FAQ, reporting a problem and downloading logs on the support page in general settings ([PR 818](https://github.com/The-Blockchain-Company/klarity/pull/818))
- Removed sending logs to remote server feature ([PR 818](https://github.com/The-Blockchain-Company/klarity/pull/818))
- Improved support dialog by default switching the "Attach logs" switch to active ([PR 829](https://github.com/The-Blockchain-Company/klarity/pull/829))
- Improved support dialog logs list (logs are now alphabetically ordered) ([PR 828](https://github.com/The-Blockchain-Company/klarity/pull/828))
- Improved manual bug report submission dialog text color in Dark blue theme ([PR 824](https://github.com/The-Blockchain-Company/klarity/pull/824))
- Improved transaction element addresses: addresses and hashes now act like linkes to Bcc Explorer ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Improved transaction element toggling: click on the white areas should collapse view (not only click on the top part) ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Improved transaction element transaction state handling: transaction with 0 confirmations is now shown in pending state ([PR 825](https://github.com/The-Blockchain-Company/klarity/pull/825))
- Improved wallet creation dialogs handling: clicking outside of the dialogs should not close them ([PR 832](https://github.com/The-Blockchain-Company/klarity/pull/832))
- Improved Dark blue theme styling of update and restoration notifications ([PR 827](https://github.com/The-Blockchain-Company/klarity/pull/827))
- Improved About dialog (team members are updated and alphabetically ordered) ([PR 830](https://github.com/The-Blockchain-Company/klarity/pull/830))
- Improved copy icons visibility on Receive screen ([PR 850](https://github.com/The-Blockchain-Company/klarity/pull/850))
- Improved error message on the NTP time synchronisation error screen ([PR 852](https://github.com/The-Blockchain-Company/klarity/pull/852))
- Improved Loading screen timeouts logic ([PR 860](https://github.com/The-Blockchain-Company/klarity/pull/860))
- Updated sidebar bug icon action to open Settings Support page instead of Support Request dialog ([PR 858](https://github.com/The-Blockchain-Company/klarity/pull/858))
- Updated the way parallel restore/imports are explaned to the user by disabling the restore/import buttons on the Add wallet dialog and presenting a user friendly message ([PR 861](https://github.com/The-Blockchain-Company/klarity/pull/861))
- Updated main and acceptance tests readme files with new acceptance tests setup information ([PR 831](https://github.com/The-Blockchain-Company/klarity/pull/831))
- Paper wallet certificate generation and wallet restoration from a paper wallet certificate acceptance tests ([PR 807](https://github.com/The-Blockchain-Company/klarity/pull/807))
- Use UTC time in Klarity logs ([PR 833](https://github.com/The-Blockchain-Company/klarity/pull/833))
- Disabled text selection on static UI elements ([PR 868](https://github.com/The-Blockchain-Company/klarity/pull/868))
- Updated Klarity and Bcc team members on the about dialog ([PR 872](https://github.com/The-Blockchain-Company/klarity/pull/872))

## 0.9.1

### Features
- New Edit section in system menu with copy & paste and related actions ([PR 817](https://github.com/The-Blockchain-Company/klarity/pull/817))

### Fixes

- A presentation bug has been fixed that caused only five recent transactions to be shown on the transaction list, even though there were more than five transactions in the wallet ([PR 778](https://github.com/The-Blockchain-Company/klarity/pull/778))
- An issue has been fixed that stopped copy and paste operations from working when initiated using the right-click context menu ([PR 817](https://github.com/The-Blockchain-Company/klarity/pull/817))
- On Windows, the desktop icon was not showing the Klarity image; this has now been fixed ([837](https://github.com/The-Blockchain-Company/klarity/pull/837))
- An error has been fixed that in some cases prevented users creating a wallet with a name containing non-latin characters, like Japanese Kanji or Chinese ([PR 840](https://github.com/The-Blockchain-Company/klarity/pull/840))

## 0.9.0

### Features

- Do not block the UI while wallet is being restored/imported ([PR 457](https://github.com/The-Blockchain-Company/klarity/pull/457))
- Start and stop Mantis Client from Klarity main process ([PR 568](https://github.com/The-Blockchain-Company/klarity/pull/568))
- Add Bcc and Mantis logo to loader screens ([PR 584](https://github.com/The-Blockchain-Company/klarity/pull/584))
- New Edit section in system menu with copy & paste and related actions ([PR 817](https://github.com/The-Blockchain-Company/klarity/pull/817))

### Fixes

- Use correct Klarity version in bug reports ([PR 948](https://github.com/The-Blockchain-Company/klarity/pull/948))
- Fixed about dialog for ETC build ([PR 586](https://github.com/The-Blockchain-Company/klarity/pull/586))
- Made `Light Blue` theme the default for ETC build ([PR 586](https://github.com/The-Blockchain-Company/klarity/pull/586))
- Fixed a bug related to gas limit when sending transactions ([PR 586](https://github.com/The-Blockchain-Company/klarity/pull/586))
- Remove transactions sorting ([PR 587](https://github.com/The-Blockchain-Company/klarity/pull/587))
- Improve ETC transaction amount validation ([PR 590](https://github.com/The-Blockchain-Company/klarity/pull/590))
- Fixed storybook and resolver issues ([PR 617](https://github.com/The-Blockchain-Company/klarity/pull/617))
- Time of your machine is different from global time. You are 0 seconds behind ([PR 678](https://github.com/The-Blockchain-Company/klarity/pull/678))
- Updated copy for the sync error screen ([PR 657](https://github.com/The-Blockchain-Company/klarity/pull/657))
- Detect when wallet is disconnected ([PR 689](https://github.com/The-Blockchain-Company/klarity/pull/689))
- Improve connecting/reconnecting messages on Loading screen ([PR 696](https://github.com/The-Blockchain-Company/klarity/pull/696))
- Send bug reports with logs from Klarity ([PR 691](https://github.com/The-Blockchain-Company/klarity/pull/691))
- Poll local time difference every 1 hour, only when connected ([PR 719](https://github.com/The-Blockchain-Company/klarity/pull/719))
- Fixed various styling issues and updated to React-Polymorph 0.6.2 ([PR 726](https://github.com/The-Blockchain-Company/klarity/pull/726))
- Fixed async restore/import dialogs logic ([PR 735](https://github.com/The-Blockchain-Company/klarity/pull/735))
- Fixed minor UI issue on receive screen when generating wallet addresses with spending password ([PR 738](https://github.com/The-Blockchain-Company/klarity/pull/738))
- Fixed `Time sync error notification` not showing up in case blocks syncing has not started ([PR 752](https://github.com/The-Blockchain-Company/klarity/pull/752))
- Properly wait for node update request ([PR 949](https://github.com/The-Blockchain-Company/klarity/pull/949))

### Chores

- Update DLL package and cleanup translation files ([PR 566](https://github.com/The-Blockchain-Company/klarity/pull/566))
- Replace electron-json-storage with electron-storage ([PR 579](https://github.com/The-Blockchain-Company/klarity/pull/579))
- Update terms of use for ETC version ([PR 606](https://github.com/The-Blockchain-Company/klarity/pull/606))
- Update Electron to version 1.7.11 which resolves security issues ([PR 677](https://github.com/The-Blockchain-Company/klarity/pull/677))
- Document Bcc SL build ([PR 654](https://github.com/The-Blockchain-Company/klarity/pull/654))
- Update about dialog content ([PR 680](https://github.com/The-Blockchain-Company/klarity/pull/680))
- Bcc redemption tests modified to run in mainnet mode ([PR 681](https://github.com/The-Blockchain-Company/klarity/pull/681))
- Log file moved to public folder and Electron crash reporter removed ([PR 682](https://github.com/The-Blockchain-Company/klarity/pull/682))

## 0.8.3

### Fixes

- Improved messages for update notifications ([PR 526](https://github.com/The-Blockchain-Company/klarity/pull/526))

## 0.8.2

### Features

- Postpone Update Api call integration ([PR 485](https://github.com/The-Blockchain-Company/klarity/pull/485))
- Wallet restore recovery phrase textarea replaced with React-Polymorph Autocomplete ([PR 516](https://github.com/The-Blockchain-Company/klarity/pull/516))
- Instructions for setting up NTP on Klarity website ([PR 531](https://github.com/The-Blockchain-Company/klarity/pull/531))

### Fixes

- Fix error message text for A to A transaction error ([PR 484](https://github.com/The-Blockchain-Company/klarity/pull/484))
- Fix "label prop type" checkbox issue in React-Polymorph ([PR 487](https://github.com/The-Blockchain-Company/klarity/pull/487))
- Remove all drag and drop instructions from UI ([PR 495](https://github.com/The-Blockchain-Company/klarity/pull/495))
- Preferences saved to local storage prefixed with network ([PR 501](https://github.com/The-Blockchain-Company/klarity/pull/501))
- Disable wallet import and export features for the mainnet ([PR 503](https://github.com/The-Blockchain-Company/klarity/pull/503))
- Correctly prevent max-window-size in electron ([PR 532](https://github.com/The-Blockchain-Company/klarity/pull/532))
- Make sure wallet import and restore in-progress notification is hidden once process is done ([PR 540](https://github.com/The-Blockchain-Company/klarity/pull/540))
- Fix broken translation files loading ([PR 559](https://github.com/The-Blockchain-Company/klarity/pull/559))
- Fix async wallet import/restore issues ([PR 562](https://github.com/The-Blockchain-Company/klarity/pull/562))

### Chores

- Update version in About dialog to 0.8.2 ([PR 496](https://github.com/The-Blockchain-Company/klarity/pull/496))
- Set Dark theme as default one for the mainnet ([PR 497](https://github.com/The-Blockchain-Company/klarity/pull/497))
- JS-Api integration ([PR 525](https://github.com/The-Blockchain-Company/klarity/pull/525))
- Only log errors to papertrail ([PR 509](https://github.com/The-Blockchain-Company/klarity/pull/509))
- Update MobX React Form to latest version ([PR 533](https://github.com/The-Blockchain-Company/klarity/pull/533))
- Update Electron, electron-devtools-installer, electron-packager and electron-rebuild to latest versions ([PR 541](https://github.com/The-Blockchain-Company/klarity/pull/541))
- Update flow-bin to version `0.59.0` ([PR 544](https://github.com/The-Blockchain-Company/klarity/pull/544))
- Cleanup and standardization of ETC Api calls ([PR 549](https://github.com/The-Blockchain-Company/klarity/pull/549))
- Unused vendor dependencies cleanup and DLL file optimization ([PR 555](https://github.com/The-Blockchain-Company/klarity/pull/555))
- Introduce `testReset` endpoint for ETC API ([PR 558](https://github.com/The-Blockchain-Company/klarity/pull/558))
- Update acceptance tests suite dependencies ([PR 561](https://github.com/The-Blockchain-Company/klarity/pull/561))
- Refactor Bcc type declarations to type folder ([PR 557](https://github.com/The-Blockchain-Company/klarity/pull/557))

## 0.8.1

### Fixes

- Fix all features eslint warnings ([PR 468](https://github.com/The-Blockchain-Company/klarity/pull/468))
- Fix for disabled buttons on dark-blue theme ([PR 473](https://github.com/The-Blockchain-Company/klarity/pull/473))
- Remove maximum screen width and height in full-screen mode ([PR 472](https://github.com/The-Blockchain-Company/klarity/pull/472))
- Fix "label click" dropdown issue in React-Polymorph ([PR 479](https://github.com/The-Blockchain-Company/klarity/pull/479))
...
- Added support for Cmd+H hotkey shortcut for hiding application window on OSX ([PR 404](https://github.com/The-Blockchain-Company/klarity/pull/404))
- Setup environment variable for testnet/mainnet mode ([PR 400](https://github.com/The-Blockchain-Company/klarity/pull/400))
- Export wallet to file ([PR 426](https://github.com/The-Blockchain-Company/klarity/pull/426))
- Add theming options in settings ([PR 370](https://github.com/The-Blockchain-Company/klarity/pull/398))
- About page, available from the system menu ([PR 430](https://github.com/The-Blockchain-Company/klarity/pull/430))
- Setup default themes for TN and MN and introduce new theme names ([PR 451](https://github.com/The-Blockchain-Company/klarity/pull/451))
- Transaction fees UX improvements on wallet sent screen ([PR 449](https://github.com/The-Blockchain-Company/klarity/pull/449))
- Acceptance tests for General Settings screens ([PR 466](https://github.com/The-Blockchain-Company/klarity/pull/466))
- Simple confirmation dialog for sending money ([PR 481](https://github.com/The-Blockchain-Company/klarity/pull/481))
- Japanese terms of use for the mainnet ([PR 486](https://github.com/The-Blockchain-Company/klarity/pull/486))

### Fixes

- Implement MomentJs internationalization
- Also quit whole app when last window is closed on osx
- Klarity and Bcc node update notification text messages change ([PR 392](https://github.com/The-Blockchain-Company/klarity/pull/392))
- Fixed brittle acceptance test steps (wallet latest transaction amount check) ([PR 393](https://github.com/The-Blockchain-Company/klarity/pull/393))
- Fixed Numeric component caret position bug on wallet send screen ([PR 394](https://github.com/The-Blockchain-Company/klarity/pull/394))
- Fixed all design implementation issues ([PR 397](https://github.com/The-Blockchain-Company/klarity/pull/397))
- Fixed eslint syntax warnings ([PR 403](https://github.com/The-Blockchain-Company/klarity/pull/403))
- Fixed wallet spending password fields error messages positioning on wallet create/restore/import dialogs ([PR 407](https://github.com/The-Blockchain-Company/klarity/pull/407))
- Fixed inline-editing success-messages on wallet settings screen ([PR 408](https://github.com/The-Blockchain-Company/klarity/pull/408))
- Fixed dialogs cut-off content on smaller screens ([PR 370](https://github.com/The-Blockchain-Company/klarity/pull/398))
- Fixed the issue of dialogs being closable while wallet import/creation/restoring is happening ([PR 393](https://github.com/The-Blockchain-Company/klarity/pull/414))
- Fixed calculation and display of transaction assurance levels ([PR 390](https://github.com/The-Blockchain-Company/klarity/pull/416))
- Fixes Transaction additional info showing/hiding affects all user's wallets ([PR 411](https://github.com/The-Blockchain-Company/klarity/pull/411))
- Fixed promise handling for unmounted wallet send form ([PR 412](https://github.com/The-Blockchain-Company/klarity/pull/412))
- Fixes Transaction toggle issue on active wallet change ([PR 421](https://github.com/The-Blockchain-Company/klarity/pull/421))
- Fixed missing 'used address' styling for default wallet address on wallet receive screen ([PR 422](https://github.com/The-Blockchain-Company/klarity/pull/422))
- Terms of service for the mainnet ([PR 425](https://github.com/The-Blockchain-Company/klarity/pull/425))
- Fixed failing acceptance tests ([PR 424](https://github.com/The-Blockchain-Company/klarity/pull/424))
- Show correct error message on sending money to Bcc redemption address ([PR 423](https://github.com/The-Blockchain-Company/klarity/pull/423))
- Fixed ENOENT error on log file rotation ([PR 428](https://github.com/The-Blockchain-Company/klarity/pull/428))
- Fixed logging error ([PR 431](https://github.com/The-Blockchain-Company/klarity/pull/431))
- Add theming support on UI which was introduced after introduction of Theming feature ([PR 434](https://github.com/The-Blockchain-Company/klarity/pull/434))
- Speed-up About page opening time ([PR 450](https://github.com/The-Blockchain-Company/klarity/pull/450))
- Importing a wallet from a file updated-API integration ([PR 439](https://github.com/The-Blockchain-Company/klarity/pull/439))
- Exporting a wallet updated-API integration ([PR 438](https://github.com/The-Blockchain-Company/klarity/pull/438))
- Show correct error message for A -> A transaction error ([PR 441](https://github.com/The-Blockchain-Company/klarity/pull/441))
- Improved QR code colors on wallet send screen for dark themes ([PR 448](https://github.com/The-Blockchain-Company/klarity/pull/448))
- Fixed transaction fees flicker on wallet send screen form submit ([PR 456](https://github.com/The-Blockchain-Company/klarity/pull/456))
- Fixed failing acceptance-tests ([PR 454](https://github.com/The-Blockchain-Company/klarity/pull/454))
- Prevent application window auto focusing while running acceptance-tests ([PR 458](https://github.com/The-Blockchain-Company/klarity/pull/458))
- Limit and validate wallet's name maximum length ([PR 465](https://github.com/The-Blockchain-Company/klarity/pull/465))
- UI/UX fixes ([PR 476](https://github.com/The-Blockchain-Company/klarity/pull/476))

### Chores

- Added readme file for running acceptance tests ([PR 395](https://github.com/The-Blockchain-Company/klarity/pull/395))
- Improved webpack build performance ([PR 402](https://github.com/The-Blockchain-Company/klarity/pull/402))
- Updated README file "Development - network options" section ([PR 410](https://github.com/The-Blockchain-Company/klarity/pull/410))
- All CSS hardcoded values replaced with variables ([PR 370](https://github.com/The-Blockchain-Company/klarity/pull/398))
- Implemented sync progress and payment requests with new JS API as first step to remove the purescript API ([PR 437](https://github.com/The-Blockchain-Company/klarity/pull/437))
- Speed optimizations for page reloads while running tests by loading bundled up for one-time tests runs ([PR 448](https://github.com/The-Blockchain-Company/klarity/pull/445))
- Optimized structure and naming of theming files ([PR 453](https://github.com/The-Blockchain-Company/klarity/pull/453))
- Added testnet label, loaded from translations for release candidate ([PR 460](https://github.com/The-Blockchain-Company/klarity/pull/460))
...
- Bcc redemption acceptance tests
...
- Spending password on "Bcc redemption" forms
...
- Final version of Klarity logo added on the loading screen
- Final version of Klarity logo added in the top-bar
- Receive page design update
- UI for displaying transaction fees on wallet send screen
- Correct placeholder text for Bcc redemption "Bcc amount" input
...
- Reset Bcc redemption form values on page load and certificate add/remove events
...
- Prevent selected wallet reset on "Bcc redemption" screen on tab or certificate change
...
- Replaced all React-Toolbox components with React-Polymorph ones ([PR 361](https://github.com/The-Blockchain-Company/klarity/pull/361))
...
- Bcc redemption testnet disclaimer on Bcc redemption pages
...
- Hamburger button" and wallet's name are present on the "Bcc redemption" and "Settings" screens
- Bcc redemption button is not enabled as soon as inputs are valid
...
- Bcc redemption with certificate decryption and parsing to extract the redemption key
...
- Bcc amounts formatting with thousands separator for displaying and entering amounts
...
- UI glitch when quickly typing in Bcc amounts on the send money form
...
- Bcc redemption overlay should also cover the wallet navigation
