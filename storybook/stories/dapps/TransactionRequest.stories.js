...
storiesOf('dApps|TransactionRequest', module)
  ...
  .add(
    ...
    withState({ selectedWallet: null }, (store) => {
      ...
      const bccAmount = number('bccAmount', 50);
      const wallets = boolean('Has wallets?', true)
        ? WALLETS_V2.map((wallet, index) => {
            ...
            if (index === 2) {
              name = `${wallet.name} - Insuficient Bcc balance`;
      ...
      return (
        <DappTransactionRequest
          ...
          bccAmount={new BigNumber(bccAmount)}
          ...
          metadata={JSON.stringify(
            {
              ...
              action: {
                ...
                url: {
                  'en-US': 'https://tbco.zendesk.com/hc/en-us/articles/',
                  'ja-JP': 'https://tbco.zendesk.com/hc/ja/articles/',
                },
              },
              publishedAt: {
                'en-US': 1569325866799,
