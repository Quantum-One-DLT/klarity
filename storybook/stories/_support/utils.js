...
import { ENTROPICS_PER_BCC } from '../../../source/renderer/app/config/numbersConfig';
import {
...
export const generateWallet = (
  ...
  new Wallet({
    id,
    addressPoolGap: 20,
    amount: new BigNumber(amount).dividedBy(ENTROPICS_PER_BCC),
    availableAmount: new BigNumber(amount).dividedBy(ENTROPICS_PER_BCC),
    reward: new BigNumber(reward).dividedBy(ENTROPICS_PER_BCC),
    assets,
    createdAt: new Date(),
    name,
...
export const isSophieTestnetTheme = (currentTheme: string) =>
  currentTheme === 'sophie-testnet';
