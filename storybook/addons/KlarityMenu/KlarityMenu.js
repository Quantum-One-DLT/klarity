...
import styles from './KlarityMenuStyles';
import {
  themeNames,
  localeNames,
  osNames,
...
export type KlarityMenuState = {
  themeName?: string,
  localeName?: string,
  osName?: string,
};

class KlarityMenu extends Component<Props, KlarityMenuState> {
  constructor(props: Props) {
    ...
    this.props.api.on('klarityMenu/paramUpdated', this.handleUpdateParam);
  }
  ...
  componentWillUnmount() {
    this.props.api.off('klarityMenu/paramUpdated', this.handleUpdateParam);
  }

  sendUpdateParam = (param: string, value: string) => {
    this.props.api.emit('klarityMenu/updateParam', { param, value });
  };
